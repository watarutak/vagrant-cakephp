class Vagrant_Cfg
  def Vagrant_Cfg.configure(config, settings)
    # Set The VM Provider
    ...
    # Configure The Box
    config.vm.define settings["name"] ||= "ubuntu-1604_lamp"
    
    config.vm.box = settings["box"] ||= "watarutak/ubuntu-16.04_lamp"
#    config.vm.box_version = settings["version"] ||= ">= 1.0.0"
    config.vm.hostname = settings["hostname"] ||= "ubuntu1604lamp"
    ...
    config.vm.provider "virtualbox" do |vb|
      vb.name = settings["name"] ||= "ubuntu-1604_lamp"
    ...
    ["vmware_fusion", "vmware_workstation"].each do |vmware|
      config.vm.provider vmware do |v|
        v.vmx["displayName"] = settings["name"] ||= "ubuntu-1604_lamp"
    ...
    config.vm.provider "parallels" do |v|
      v.name = settings["name"] ||= "ubuntu-1604_lamp"
